      ...
      <div className="aboutMeContent">
        ...
        <div className="introSection">
          ...
          <p className="introText">
            ...
            applications, cyber security, and many others.
          </p>
        </div>
        <Row>
          <Col key={1}>
            <div className="profileSection">
              ...
              <p className="aboutText">
                I am a new graduate, and currently looking for full time positions
                in Computer Science and Software Egineering. If you are interested
                in me, please reach out via <a className="anchor" href="mailto:samisamara548@gmail.com">samisamara548@gmail.com</a>
              </p>
          ...
          <Col key={2}>
            <div className="skills">
              ...
              <p>
                I have developed my skills in Computer Science over the years, as
                well as other varying skills centered around design. Below are
                highlights of those technical skills.
              </p>
              <SkillBar />
            </div>
          </Col>
